...
from .converter import PngToIcoConverterCore, MAX_FILE_SIZE_MB, ICON_SIZE_MIN, ICON_SIZE_MAX, DEFAULT_ICON_SIZE
...
class ConvertThread(QThread):
    ...
    def run(self):
        try:
            ...
            # 使用核心转换器进行转换
            success, message = PngToIcoConverterCore.convert(self.png_path, self.ico_path, self.size)
...
class PngToIcoConverterGUI(QMainWindow):
    def __init__(self):
        super().__init__()
